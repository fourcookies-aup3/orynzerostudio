...
export const projects: Project[] = [
  {
    ...
    production:
      "An intensive one-day shoot utilizing synchronized high-speed drone pilots and steady ground cameras, following coordinated lines across pre-scouted urban obstacles.",
    result:
